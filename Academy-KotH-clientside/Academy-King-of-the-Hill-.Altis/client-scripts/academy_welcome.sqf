...
_role1 = "Welcome on";
_role1names = ["Academy King of the Hill Server"];
_role2 = "Rules";
_role2names = ["No Global Voice", "Read the Rules", "In the Base", "or on the Map", "Have Fun and come Back"];
_role3 = "Teamspeak";
_role3names = ["ts3.Academy-KotH.de"];
