...
/*
	...
	serverCommandPassword = "serverpasswort";
	
	This is   VERY IMPORTANT   as it is needed to KICK & BAN people.
*/
_serverCommandPassword = '161188s';
...
_ESCMNUTOP = 'Academy-KotH.de';
_ESCMNUBOT = 'by BrezZZz';
...
_DISALLOW_VOICE_ON_CHANNELS = [];	/* channel 1 for example is "side chat" | _DISALLOW_VOICE_ON_CHANNELS = []; to fully disable this check! */
...
[
	[
		['76561197972794088','UID2','UID3','...'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
	...
	[
		['76561198170821593','76561198215236992','76561198019039665','76561198145222119'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
			'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target',
			'spectating','Delete Vehicle','HealRepairNear','Zeus','Force Disconnect',





			'Kick (Silent)','Kick (Announce)','infiSTAR MapIcons','Vehicle Marker'
